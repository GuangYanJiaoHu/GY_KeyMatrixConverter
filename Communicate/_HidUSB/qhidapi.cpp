 ...
 * \param 跑； The Serial Number of the device to open (Optionally NULL).
...
quint32 QHidApi::open(int ser_number=0, ushort vendor_id, ushort product_id, QString serialNumber)
{

    return d_ptr->open(ser_number,vendor_id, product_id, serialNumber);
}
