...
public:
    ...
    quint32 open(int ser_number,ushort vendor_id, ushort product_id, QString serial_number=QString());
    ...
    quint32 openNewProduct(int ser_number,ushort vendorId, ushort productId, QString serialNumber);
