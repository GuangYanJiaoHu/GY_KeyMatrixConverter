...
"} "));
        ...
        horizontalSlider_PixmapHeight->setMaximum(1000);
        ...
        horizontalSlider_PixmapWidth->setMaximum(1000);
        ...
        spinBox_PixmapWidth->setMaximum(1000);
        ...
        spinBox_PixmapHeight->setMaximum(1000);
