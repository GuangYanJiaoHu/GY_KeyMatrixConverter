...
public:
    ...
    QPushButton *pushButton_ReadJson;
    QGroupBox *groupBox_8;
    QGridLayout *gridLayout_29;
    QLabel *label;
    QWidget *widget_3;
    QListWidget *listWidget_ReadJson;
    QWidget *tab;
    QGridLayout *gridLayout_6;
    QWidget *widget_2;
    QGridLayout *gridLayout_14;
    QPushButton *pushButton;
    QLineEdit *lineEdit_TurnOn;
    QFrame *line_2;
    ...
    QLabel *label_dengWei;
    QSpinBox *spinBox_dengWei;
    ...
    QLabel *label_liangDu;
    QSpinBox *spinBox_LiangDu;
    QFrame *line;
    QHBoxLayout *horizontalLayout_9;
    QCheckBox *checkBox_shiShiJiaoZhun;
    QCheckBox *checkBox_returnSpeed;
    QWidget *widget_21;
    ...
    void setupUi(QWidget *GY_GenerateBinFile)
    {
        ...
        GY_GenerateBinFile->resize(1012, 463);
        ...
        widget->setStyleSheet(QString::fromUtf8("QlistWidget{\n"
"	color: rgb(255, 255, 255);\n"
"	background: transparent;\n"
"	\n"
"}\n"
"/*\346\216\247\345\210\266item\347\232\204\347\224\237\346\210\220\351\225\277\345\272\246\357\274\214\351\242\234\350\211\262\357\274\214\346\240\267\345\274\217*/\n"
"QListWidget::item { \n"
"	color: rgb(0, 0, 0);\n"
"	\n"
"    padding-right:5px;\n"
...
"    background-color: rgba(91, 137, 254, 80);\n"
"}\n"
...
"	border-left: 2px solid rgba(255, 0, 0, 255);\n"
"}\n"
"\n"
"/*\346\273\232\345\212\250\346\235\241\346\240\267\345\274\217\344\277\256\346\224\271*/\n"
"QScrollBar:vertical {\n"
"    border: none;\n"
"    background: none;\n"
"    width: 10px;\n"
...
""
                        "    background-color: rgba(91, 137, 254, 255);\n"
...
"}"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 1010, 461));
        QFont font;
...
"} "));
        ...
        pushButton_ReadJson = new QPushButton(tab_4);
        pushButton_ReadJson->setObjectName("pushButton_ReadJson");
        pushButton_ReadJson->setMinimumSize(QSize(120, 40));
        QFont font2;
        font2.setPointSize(10);
        font2.setBold(true);
        pushButton_ReadJson->setFont(font2);

        gridLayout_15->addWidget(pushButton_ReadJson, 0, 1, 1, 1);
        ...
        gridLayout_29->addWidget(label, 0, 0, 1, 1);

        widget_3 = new QWidget(groupBox_8);
        widget_3->setObjectName("widget_3");

        gridLayout_29->addWidget(widget_3, 1, 0, 1, 1);


        gridLayout_15->addWidget(groupBox_8, 0, 2, 1, 1);

        listWidget_ReadJson = new QListWidget(tab_4);
        listWidget_ReadJson->setObjectName("listWidget_ReadJson");
        listWidget_ReadJson->setStyleSheet(QString::fromUtf8("font: 9pt \"\345\276\256\350\275\257\351\233\205\351\273\221\";"));
        listWidget_ReadJson->setFrameShape(QFrame::Shape::Box);

        gridLayout_15->addWidget(listWidget_ReadJson, 0, 0, 1, 1);
        ...
        lineEdit_TurnOn = new QLineEdit(widget_2);
        lineEdit_TurnOn->setObjectName("lineEdit_TurnOn");
        QFont font3;
        font3.setFamilies({QString::fromUtf8("\345\276\256\350\275\257\351\233\205\351\273\221")});
        font3.setBold(true);
        lineEdit_TurnOn->setFont(font3);
        lineEdit_TurnOn->setReadOnly(true);

        gridLayout_14->addWidget(lineEdit_TurnOn, 0, 0, 1, 1);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 1006, 384));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 322, 382));
        ...
        pushButton_Deep->setMinimumSize(QSize(0, 30));
        ...
        gridLayout_8->addWidget(scrollArea_6, 0, 4, 1, 1);
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 322, 382));
        ...
        pushButton_Dynamic->setMinimumSize(QSize(0, 30));
        pushButton_Dynamic->setMaximumSize(QSize(16777215, 25));
        pushButton_Dynamic->setFont(font4);
        ...
        gridLayout_8->addWidget(scrollArea_4, 0, 2, 1, 1);
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 322, 382));
        ...
        pushButton_Static->setMinimumSize(QSize(0, 30));
        pushButton_Static->setMaximumSize(QSize(16777215, 25));
        pushButton_Static->setFont(font4);
        pushButton_Static->setStyleSheet(QString::fromUtf8(""));
        ...
        line_6 = new QFrame(scrollAreaWidgetContents_3);
        line_6->setObjectName("line_6");
        line_6->setFrameShape(QFrame::Shape::VLine);
        line_6->setFrameShadow(QFrame::Shadow::Sunken);

        gridLayout_8->addWidget(line_6, 0, 1, 1, 1);

        line_7 = new QFrame(scrollAreaWidgetContents_3);
        line_7->setObjectName("line_7");
        line_7->setFrameShape(QFrame::Shape::VLine);
        line_7->setFrameShadow(QFrame::Shadow::Sunken);

        gridLayout_8->addWidget(line_7, 0, 3, 1, 1);
...
"} "));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 984, 397));
        gridLayout_7 = new QGridLayout(scrollAreaWidgetContents_2);
        gridLayout_7->setSpacing(0);
        gridLayout_7->setObjectName("gridLayout_7");
        gridLayout_7->setContentsMargins(0, 0, -1, 0);
        ...
        gridLayout_4->setContentsMargins(11, 0, 11, 0);
        horizontalLayout_7 = new QHBoxLayout();
        horizontalLayout_7->setObjectName("horizontalLayout_7");
        label_dengWei = new QLabel(groupBox);
        label_dengWei->setObjectName("label_dengWei");
        label_dengWei->setMinimumSize(QSize(70, 0));
        label_dengWei->setMaximumSize(QSize(70, 16777215));
        label_dengWei->setFont(font1);

        horizontalLayout_7->addWidget(label_dengWei);

        spinBox_dengWei = new QSpinBox(groupBox);
        spinBox_dengWei->setObjectName("spinBox_dengWei");
        spinBox_dengWei->setFont(font1);
        spinBox_dengWei->setMinimum(1);
        spinBox_dengWei->setMaximum(4);
        spinBox_dengWei->setValue(3);

        horizontalLayout_7->addWidget(spinBox_dengWei);
        ...
        label_whiteBalance_B->setMinimumSize(QSize(70, 0));
        label_whiteBalance_B->setMaximumSize(QSize(70, 16777215));
        ...
        label_keyMin->setMinimumSize(QSize(70, 0));
        label_keyMin->setMaximumSize(QSize(70, 16777215));
        ...
        doubleSpinBox_keyMin->setValue(0.300000000000000);

        horizontalLayout_3->addWidget(doubleSpinBox_keyMin);


        gridLayout_4->addLayout(horizontalLayout_3, 12, 0, 1, 1);
        ...
        pushButton_keyMaxorMinValue->setMinimumSize(QSize(0, 40));
        pushButton_keyMaxorMinValue->setMaximumSize(QSize(16777215, 40));
        pushButton_keyMaxorMinValue->setFont(font4);

        gridLayout_4->addWidget(pushButton_keyMaxorMinValue, 13, 0, 1, 1);

        horizontalLayout_2 = new QHBoxLayout();
        horizontalLayout_2->setObjectName("horizontalLayout_2");
        label_keyMax = new QLabel(groupBox);
        label_keyMax->setObjectName("label_keyMax");
        label_keyMax->setMinimumSize(QSize(70, 0));
        label_keyMax->setMaximumSize(QSize(70, 16777215));
        ...
        doubleSpinBox_keyMax->setValue(1.100000000000000);

        horizontalLayout_2->addWidget(doubleSpinBox_keyMax);


        gridLayout_4->addLayout(horizontalLayout_2, 11, 0, 1, 1);

        horizontalLayout = new QHBoxLayout();
        horizontalLayout->setObjectName("horizontalLayout");
        label_shaftInfo_2 = new QLabel(groupBox);
        label_shaftInfo_2->setObjectName("label_shaftInfo_2");
        label_shaftInfo_2->setMinimumSize(QSize(70, 0));
        label_shaftInfo_2->setMaximumSize(QSize(70, 16777215));
        ...
        comboBox_ShaftType = new QComboBox(groupBox);
        comboBox_ShaftType->addItem(QString());
        comboBox_ShaftType->addItem(QString());
        comboBox_ShaftType->addItem(QString());
        comboBox_ShaftType->addItem(QString());
        comboBox_ShaftType->addItem(QString());
        comboBox_ShaftType->setObjectName("comboBox_ShaftType");
        comboBox_ShaftType->setFont(font1);
        comboBox_ShaftType->setStyleSheet(QString::fromUtf8("color: rgb(255, 0, 0);"));

        horizontalLayout->addWidget(comboBox_ShaftType);


        gridLayout_4->addLayout(horizontalLayout, 10, 0, 1, 1);

        horizontalLayout_5 = new QHBoxLayout();
        horizontalLayout_5->setObjectName("horizontalLayout_5");
        label_whiteBalance_G = new QLabel(groupBox);
        label_whiteBalance_G->setObjectName("label_whiteBalance_G");
        label_whiteBalance_G->setMinimumSize(QSize(70, 0));
        label_whiteBalance_G->setMaximumSize(QSize(70, 16777215));
        ...
        label_whiteBalance_R->setMinimumSize(QSize(70, 0));
        label_whiteBalance_R->setMaximumSize(QSize(70, 16777215));
        ...
        label_liangDu = new QLabel(groupBox);
        label_liangDu->setObjectName("label_liangDu");
        label_liangDu->setMinimumSize(QSize(70, 0));
        label_liangDu->setMaximumSize(QSize(70, 16777215));
        label_liangDu->setFont(font1);

        horizontalLayout_10->addWidget(label_liangDu);

        spinBox_LiangDu = new QSpinBox(groupBox);
        spinBox_LiangDu->setObjectName("spinBox_LiangDu");
        spinBox_LiangDu->setFont(font1);
        spinBox_LiangDu->setMaximum(255);
        spinBox_LiangDu->setValue(255);

        horizontalLayout_10->addWidget(spinBox_LiangDu);
        ...
        gridLayout_4->addWidget(line, 9, 0, 1, 1);

        horizontalLayout_9 = new QHBoxLayout();
        horizontalLayout_9->setObjectName("horizontalLayout_9");
        checkBox_shiShiJiaoZhun = new QCheckBox(groupBox);
        checkBox_shiShiJiaoZhun->setObjectName("checkBox_shiShiJiaoZhun");
        checkBox_shiShiJiaoZhun->setFont(font1);
        checkBox_shiShiJiaoZhun->setChecked(true);

        horizontalLayout_9->addWidget(checkBox_shiShiJiaoZhun);

        checkBox_returnSpeed = new QCheckBox(groupBox);
        checkBox_returnSpeed->setObjectName("checkBox_returnSpeed");
        checkBox_returnSpeed->setFont(font1);
        checkBox_returnSpeed->setChecked(true);

        horizontalLayout_9->addWidget(checkBox_returnSpeed);
        ...
        doubleSpinBox_minTop->setFont(font1);
        doubleSpinBox_minTop->setMinimum(-100.000000000000000);
        doubleSpinBox_minTop->setValue(0.700000000000000);
        ...
        label_acoefficientB->setMinimumSize(QSize(60, 0));
        label_acoefficientB->setMaximumSize(QSize(60, 16777215));
        label_acoefficientB->setFont(font1);
        label_acoefficientB->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        doubleSpinBox_maxDefault->setFont(font1);
        doubleSpinBox_maxDefault->setMinimum(-100.000000000000000);
        doubleSpinBox_maxDefault->setValue(1.000000000000000);

        gridLayout_5->addWidget(doubleSpinBox_maxDefault, 2, 1, 1, 1);

        label_minDefault = new QLabel(groupBox_3);
        label_minDefault->setObjectName("label_minDefault");
        label_minDefault->setFont(font1);
        label_minDefault->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_acoefficientC->setMinimumSize(QSize(60, 0));
        label_acoefficientC->setMaximumSize(QSize(60, 16777215));
        label_acoefficientC->setFont(font1);
        label_acoefficientC->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_fhTop->setFont(font1);
        label_fhTop->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_rtTop->setFont(font1);
        label_rtTop->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        gridLayout_5->addWidget(label_rtTop, 4, 4, 1, 1);

        doubleSpinBox_rtTop = new QDoubleSpinBox(groupBox_3);
        doubleSpinBox_rtTop->setObjectName("doubleSpinBox_rtTop");
        doubleSpinBox_rtTop->setFont(font1);
        doubleSpinBox_rtTop->setMinimum(-100.000000000000000);
        doubleSpinBox_rtTop->setValue(3.400000000000000);

        gridLayout_5->addWidget(doubleSpinBox_rtTop, 4, 5, 1, 1);

        label_acoefficientD = new QLabel(groupBox_3);
        label_acoefficientD->setObjectName("label_acoefficientD");
        label_acoefficientD->setMinimumSize(QSize(60, 0));
        label_acoefficientD->setMaximumSize(QSize(60, 16777215));
        label_acoefficientD->setFont(font1);
        label_acoefficientD->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_minBtm->setFont(font1);
        label_minBtm->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        gridLayout_5->addWidget(label_minBtm, 6, 0, 1, 1);

        doubleSpinBox_minBtm = new QDoubleSpinBox(groupBox_3);
        doubleSpinBox_minBtm->setObjectName("doubleSpinBox_minBtm");
        doubleSpinBox_minBtm->setFont(font1);
        doubleSpinBox_minBtm->setMinimum(-100.000000000000000);
        ...
        doubleSpinBox_acoefficientD_2->setFont(font1);
        doubleSpinBox_acoefficientD_2->setDecimals(8);
        doubleSpinBox_acoefficientD_2->setMinimum(-100.000000000000000);
        doubleSpinBox_acoefficientD_2->setValue(35.185333000000000);
        ...
        label_deadZoneDown_3->setMinimumSize(QSize(60, 0));
        label_deadZoneDown_3->setMaximumSize(QSize(60, 16777215));
        label_deadZoneDown_3->setFont(font1);
        label_deadZoneDown_3->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_deadZoneUp_3->setMinimumSize(QSize(60, 0));
        label_deadZoneUp_3->setMaximumSize(QSize(60, 16777215));
        label_deadZoneUp_3->setFont(font1);
        label_deadZoneUp_3->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_maxBtm_2->setFont(font1);
        label_maxBtm_2->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        gridLayout_18->addWidget(label_maxBtm_2, 10, 0, 1, 1);

        label_minTop_2 = new QLabel(groupBox_4);
        label_minTop_2->setObjectName("label_minTop_2");
        label_minTop_2->setFont(font1);
        label_minTop_2->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_acoefficientB_2->setMinimumSize(QSize(60, 0));
        label_acoefficientB_2->setMaximumSize(QSize(60, 16777215));
        label_acoefficientB_2->setFont(font1);
        label_acoefficientB_2->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        doubleSpinBox_fhBtm_2->setFont(font1);
        ...
        doubleSpinBox_deadZoneDown_2->setFont(font1);
        doubleSpinBox_deadZoneDown_2->setMinimum(0.000000000000000);
        doubleSpinBox_deadZoneDown_2->setMaximum(292.000000000000000);
        doubleSpinBox_deadZoneDown_2->setStepType(QAbstractSpinBox::StepType::DefaultStepType);
        doubleSpinBox_deadZoneDown_2->setValue(0.400000000000000);
        ...
        label_fhBtm_2->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        gridLayout_20 = new QGridLayout(page_3);
        ...
        doubleSpinBox_minBtm_3->setValue(0.200000000000000);

        gridLayout_19->addWidget(doubleSpinBox_minBtm_3, 6, 1, 1, 1);

        label_minBtm_3 = new QLabel(groupBox_5);
        label_minBtm_3->setObjectName("label_minBtm_3");
        label_minBtm_3->setFont(font1);
        ...
        doubleSpinBox_maxDefault_4->setFont(font1);
        doubleSpinBox_maxDefault_4->setValue(1.000000000000000);
        ...
        label_acoefficientB_4->setMinimumSize(QSize(60, 0));
        label_acoefficientB_4->setMaximumSize(QSize(60, 16777215));
        label_acoefficientB_4->setFont(font1);
        label_acoefficientB_4->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_acoefficientA_4->setMinimumSize(QSize(60, 0));
        label_acoefficientA_4->setMaximumSize(QSize(60, 16777215));
        label_acoefficientA_4->setFont(font1);
        label_acoefficientA_4->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);

        gridLayout_23->addWidget(label_acoefficientA_4, 3, 2, 1, 1);

        doubleSpinBox_acoefficientC_4 = new QDoubleSpinBox(groupBox_6);
        doubleSpinBox_acoefficientC_4->setObjectName("doubleSpinBox_acoefficientC_4");
        doubleSpinBox_acoefficientC_4->setFont(font1);
        doubleSpinBox_acoefficientC_4->setDecimals(8);
        doubleSpinBox_acoefficientC_4->setMinimum(-100.000000000000000);
        doubleSpinBox_acoefficientC_4->setValue(-29.737660000000002);
        ...
        doubleSpinBox_fhDnDft_4->setFont(font1);
        doubleSpinBox_fhDnDft_4->setValue(1.700000000000000);
        ...
        label_acoefficientD_4->setMinimumSize(QSize(60, 0));
        label_acoefficientD_4->setMaximumSize(QSize(60, 16777215));
        label_acoefficientD_4->setFont(font1);
        label_acoefficientD_4->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        doubleSpinBox_minDefault_4->setFont(font1);
        doubleSpinBox_minDefault_4->setValue(0.400000000000000);
        ...
        doubleSpinBox_acoefficientD_4->setFont(font1);
        doubleSpinBox_acoefficientD_4->setDecimals(8);
        doubleSpinBox_acoefficientD_4->setMinimum(-100.000000000000000);
        doubleSpinBox_acoefficientD_4->setValue(35.168070999999998);
        ...
        doubleSpinBox_deadZoneUp_4->setMinimum(0.000000000000000);
        doubleSpinBox_deadZoneUp_4->setMaximum(282.000000000000000);
        doubleSpinBox_deadZoneUp_4->setValue(0.400000000000000);
        ...
        gridLayout_24 = new QGridLayout(page_5);
        ...
        doubleSpinBox_minTop_5->setValue(0.700000000000000);
        ...
        doubleSpinBox_acoefficientD_5->setFont(font1);
        doubleSpinBox_acoefficientD_5->setDecimals(8);
        doubleSpinBox_acoefficientD_5->setMinimum(-100.000000000000000);
        doubleSpinBox_acoefficientD_5->setValue(35.374484000000002);

        gridLayout_25->addWidget(doubleSpinBox_acoefficientD_5, 8, 3, 1, 1);

        doubleSpinBox_acoefficientB_5 = new QDoubleSpinBox(groupBox_7);
        doubleSpinBox_acoefficientB_5->setObjectName("doubleSpinBox_acoefficientB_5");
        doubleSpinBox_acoefficientB_5->setFont(font1);
        doubleSpinBox_acoefficientB_5->setDecimals(8);
        doubleSpinBox_acoefficientB_5->setMinimum(-100.000000000000000);
        doubleSpinBox_acoefficientB_5->setValue(62.853794999999998);
        ...
        label_maxDefault_5->setFont(font1);
        label_maxDefault_5->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_deadZoneDown_5->setMinimumSize(QSize(60, 0));
        label_deadZoneDown_5->setMaximumSize(QSize(60, 16777215));
        label_deadZoneDown_5->setFont(font1);
        label_deadZoneDown_5->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        label_rtUpDft_5->setFont(font1);
        label_rtUpDft_5->setAlignment(Qt::AlignmentFlag::AlignRight|Qt::AlignmentFlag::AlignTrailing|Qt::AlignmentFlag::AlignVCenter);
        ...
        doubleSpinBox_rtTop_5->setValue(1.500000000000000);
        ...
        doubleSpinBox_rtBtm_5->setFont(font1);
        doubleSpinBox_rtBtm_5->setValue(0.200000000000000);
        ...
        gridLayout_28->addWidget(scrollArea_2, 0, 0, 1, 1);
        ...
        label_dynamic_2 = new QLabel(layoutWidget);
        ...
        comboBox_keyboardType = new QComboBox(layoutWidget);
...
"background-color: rgb(60, 60, 60);"));
        comboBox_keyboardType->setDuplicatesEnabled(false);

        horizontalLayout_8->addWidget(comboBox_keyboardType);
    ...
    void retranslateUi(QWidget *GY_GenerateBinFile)
    {
        ...
        pushButton_ReadJson->setText(QCoreApplication::translate("GY_GenerateBinFile", "Json\346\226\207\344\273\266\350\257\273\345\217\226", nullptr));
        groupBox_8->setTitle(QCoreApplication::translate("GY_GenerateBinFile", "JSON\344\277\241\346\201\257", nullptr));
        label->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_4), QCoreApplication::translate("GY_GenerateBinFile", "Json\346\226\207\344\273\266\350\257\273\345\217\226", nullptr));
        ...
        lineEdit_TurnOn->setInputMask(QString());
        lineEdit_TurnOn->setText(QCoreApplication::translate("GY_GenerateBinFile", "\345\274\200\346\234\272\345\212\250\347\224\273\345\234\260\345\235\200", nullptr));
        ...
        label_dengWei->setText(QCoreApplication::translate("GY_GenerateBinFile", "\344\270\212\344\270\213\347\201\257\344\275\215", nullptr));
        ...
        label_shaftInfo_2->setText(QCoreApplication::translate("GY_GenerateBinFile", "\350\275\264\344\275\223\347\261\273\345\236\213", nullptr));
        comboBox_ShaftType->setItemText(0, QCoreApplication::translate("GY_GenerateBinFile", "\350\275\264\344\275\223A(\351\273\230\350\256\244)", nullptr));
        comboBox_ShaftType->setItemText(1, QCoreApplication::translate("GY_GenerateBinFile", "\350\275\264\344\275\223B", nullptr));
        comboBox_ShaftType->setItemText(2, QCoreApplication::translate("GY_GenerateBinFile", "\350\275\264\344\275\223C", nullptr));
        comboBox_ShaftType->setItemText(3, QCoreApplication::translate("GY_GenerateBinFile", "\350\275\264\344\275\223D", nullptr));
        comboBox_ShaftType->setItemText(4, QCoreApplication::translate("GY_GenerateBinFile", "\350\275\264\344\275\223E", nullptr));
        ...
        label_liangDu->setText(QCoreApplication::translate("GY_GenerateBinFile", "\351\273\230\350\256\244\344\272\256\345\272\246", nullptr));
        checkBox_shiShiJiaoZhun->setText(QCoreApplication::translate("GY_GenerateBinFile", "\345\256\236\346\227\266\346\240\241\345\207\206", nullptr));
        checkBox_returnSpeed->setText(QCoreApplication::translate("GY_GenerateBinFile", "\345\233\236\346\212\245\347\216\207", nullptr));
        ...
        comboBox_keyboardType->setItemText(0, QCoreApplication::translate("GY_GenerateBinFile", "\344\270\215\350\246\201\345\277\230\350\256\260\351\200\211\346\213\251\351\224\256\347\233\230\347\261\273\345\236\213", nullptr));
        comboBox_keyboardType->setItemText(1, QCoreApplication::translate("GY_GenerateBinFile", "\347\243\201\350\275\264\351\241\271\347\233\256-70\351\205\215\345\210\227\351\224\256\347\233\230", nullptr));

        tabWidget->setTabText(tabWidget->indexOf(tab_3), QCoreApplication::translate("GY_GenerateBinFile", "\345\257\274\345\207\272\351\205\215\347\275\256", nullptr));
    } // retranslateUi
